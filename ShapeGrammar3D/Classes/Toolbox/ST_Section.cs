...
namespace ShapeGrammar3D.Classes.Toolbox
{
    ...
    public class TB_Section
    {
        ...
        {
            return (TB_Section)base.MemberwiseClone();
        }
    ...
    [Serializable]
    public class Section_Rect : TB_Section
    {
        // --- field ---
        ...
        public Section_Rect() { }
        public Section_Rect(TB_Material _mat, string _tag, double _b, double _h, double _theta = 0.0)
        {
            // class field
            B = _b;
            H = _h;
    ...
    [Serializable]
    public class Section_Circular : TB_Section
    {
        // --- field ---
        ...
        public Section_Circular(TB_Material _mat, string _tag, double _d)
        {
            // class field
            D = _d;
    ...
    [Serializable]
    public class Section_I : TB_Section
    {
        // --- field ---
        public double H { get; private set; }
        ...
        public Section_I() { }
        public Section_I(TB_Material _mat, string _tag, double _h, double _w, double _tw, double _tf, double _theta = 0.0)
        {
            // class field
            H = _h;
            W = _w;
    ...
    public class Section_RHS : TB_Section
    {
        ...
        public Section_RHS() { }
        public Section_RHS(TB_Material _mat, string _tag, double _h, double _w, double _tw, double _tf, double _theta=0.0)
        {
            // class field
            H = _h;
            W = _w;
    ...
    [Serializable]
    public class Section_CHS : TB_Section
    {
        // --- field ---
        public double D { get; private set; }
        ...
        // --- constructors --- 
        public Section_CHS() { }
        public Section_CHS(TB_Material _mat, string _tag, double _d, double _t)
        {
            // class field
            D = _d;
            T = _t;
    ...
    public class GH_Section : GH_Goo<TB_Section>
    {
        ...
        public GH_Section(TB_Section sec) : base(sec)
        {
            this.Value = sec;
        }
    ...
    public class Param_Section : GH_PersistentParam<GH_Section>
    {
        ...
        protected override System.Drawing.Bitmap Icon { get {
                return global::ShapeGrammar3D.Properties.Resources.icons_P_Sec;
            } }  //Set icon image
