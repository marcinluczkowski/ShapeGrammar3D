...
namespace ShapeGrammar3D.Classes.Toolbox
{
    ...
    public class Node
    {
        ...
        public TB_Support Sup { get; set; } = null;
        public List<double[]> Disps { get; private set; } = new List<double[]>();

        public List<TB_Element_1D> Elems { get; private set; } = new List<TB_Element_1D>();
    ...
    public class Param_Node : GH_PersistentParam<GH_Node>
    {
        ...
        protected override System.Drawing.Bitmap Icon { get {
                return global::ShapeGrammar3D.Properties.Resources.icons_P_Node;
            } }  //Set icon image
