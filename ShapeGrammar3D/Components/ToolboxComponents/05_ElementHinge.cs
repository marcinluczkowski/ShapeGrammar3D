...
namespace ShapeGrammar3D.Components.ToolboxComponents
{
    public class ST_ElementHinge : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                TB_Element_1D e = new TB_Element_1D(gh_e.Value.Line, gh_e.Value.Tag, gh_e.Value.Sec, gh_e.Value.Vz, gh_e.Value.Buckling_Length);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.icons_C_ElemHinge;
            }
        }
        ...
        {
            get { return new Guid("4155dc77-750b-4c30-9924-4644f1b2f859"); }
        }
    }
}