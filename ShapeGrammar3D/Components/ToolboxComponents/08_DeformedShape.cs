...
namespace ShapeGrammar3D.Components.ToolboxComponents
{
    public class ST_DeformedShape : GH_Component
    {
        ...
        {
            pManager.RegisterParam(new Param_TB_Model(), "DefModel", "Def M", "Deformed Model", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                Node sn = e.Nodes[0]; //mdl.Nodes.Where(n => n == e.Nodes[0]).ToList()[0];
                Node en = e.Nodes[1]; // mdl.Nodes.Where(n => n == e.Nodes[1]).ToList()[0];
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.icons_C_Def;
            }
        }
        ...
        {
            get { return new Guid("9946baff-827d-4533-b99a-57de66863835"); }
        }
    }
}