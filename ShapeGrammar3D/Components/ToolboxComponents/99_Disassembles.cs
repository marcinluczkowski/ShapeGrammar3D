...
namespace ShapeGrammar3D.Components.ToolboxComponents
{
    public class Disassemble_Material : GH_Component
    {
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.icons_I_Sec;
            }
        }
    ...
    public class Disassemble_Element_1D : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                TB_Element_1D e = gh_elem1Ds[i].Value;
    ...
    public class Disassemble_Node : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("disp", "disp", "", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            for (var i = 0; i < gh_nds.Count; i++)
            {
                if (gh_nds[i].Value.Disps != null && gh_nds[i].Value.Disps.Count() != 0)
                {
                    disps.AddRange(gh_nds[i].Value.Disps[0]);
                }
    ...
    public class Disassemble_Load_Pt : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (GH_Load gl in gh_lds)
            {
                ...
                if (!(l is TB_Load_Point lp)) continue;
